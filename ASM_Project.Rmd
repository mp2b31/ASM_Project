...
plot(m,v,xlab="Medias anuales",ylab="Annual Variances",main="serie")
...
```{r}
(mod1=arima(d1d12lnserie,order=c(0,0,2),seasonal=list(order=c(4,0,0),period=12)))
```
...
```{r}
(mod1=arima(lnserie,order=c(0,1,2),seasonal=list(order=c(4,1,0),period=12)))
```
...
```{r}
(mod2=arima(d1d12lnserie,order=c(0,0,4),seasonal=list(order=c(4,0,0),period=12)))
```
...
```{r}
(mod2=arima(lnserie,order=c(0,1,4),seasonal=list(order=c(4,1,0),period=12)))
```
...
```{r}
(mod.lin=arima(lnserie.lin,order=c(0,1,4),seasonal=list(order=c(0,1,4),period=12)))
```
