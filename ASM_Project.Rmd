...
ts.plot(reduced,tl,tu,pr,lty=c(1,2,2,1),col=c(1,4,4,2),xlim=ultim[1]+c(-3,2),type="o",main="Model ARIMA(2,1,0)(4,1,0)12+TD+Easter+Outliers")
...
ts.plot(serie,tl3,tu3,pr3,lty=c(1,2,2,1),col=c(1,4,4,2),xlim=ultim[1]+c(-2,3),ylim=c(500,2000),type="o",main="Model ARIMA(2,1,0)(4,1,0)12+TD+Easter+Outliers")
